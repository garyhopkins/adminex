...
type ModelFunc func(context.Context, *entgen.ModelMutation) (entgen.Value, error)

// Mutate calls f(ctx, m).
func (f ModelFunc) Mutate(ctx context.Context, m entgen.Mutation) (entgen.Value, error) {
	if mv, ok := m.(*entgen.ModelMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *entgen.ModelMutation", m)
}
